...
let songs = [
    ...
    {songName: "Kalla-Sohna-Nai", filePath:"songs/Ranjha.mp3", coverPath:"covers/2.jpg"},
    {songName: "Insane", filePath:"songs/Ranjha.mp3",coverPath:"covers/3.jpg"},
    {songName: "Excuses", filePath:"songs/Ranjha.mp3",coverPath:"covers/4.jpg"},
    {songName: "Desires", filePath:"songs/Ranjha.mp3",coverPath:"covers/5.jpg"},
    {songName: "Bijlee", filePath:"songs/Ranjha.mp3",coverPath:"covers/6.jpg"},
] //copied same song file to save memory
...
Array.from(document.getElementsByClassName('songItemPlay')).forEach((element)=>{
    element.addEventListener('click',(e)=>{
        ...
        document.getElementById('songSinger').textContent = songs[songIndex].songName;
    })
})
